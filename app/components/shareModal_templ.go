...
func ShareModal() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<input class=\"modal-state\" id=\"modal-share\" type=\"checkbox\"><div class=\"modal\"><div id=\"alert-container\" class=\"absolute z-40\"></div><label class=\"modal-overlay\" for=\"modal-share\"></label><div class=\"modal-content flex flex-row gap-5\">")
		if templ_7745c5c3_Err != nil {
		...
		for _, socialMediaShare := range constants.SocialShareButtons {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/components/shareModal.templ`, Line: 20, Col: 54}
			}
			...
			templ_7745c5c3_Err = LinkItem(formatSafeURL(socialMediaShare.URL), "").Render(templ.WithChildren(ctx, templ_7745c5c3_Var3), templ_7745c5c3_Buffer)
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
