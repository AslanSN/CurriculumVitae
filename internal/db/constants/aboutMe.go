...
var AboutMe = map[i18n.Locale]string{
	i18n.EN: `Senior full-stack engineer (~4.5 years) who ships end to end — React 19 / Next.js + TypeScript on the front, real .NET / PostgreSQL on the back, plus platform work (CI/CD, testing, observability). I work AI-native: Claude Code, LLM agents and MCP are part of how I ship, and I authored my team's shared AI-engineering conventions. At a smart-building SaaS I ran frontend delivery autonomously, and in my final stretch took over cross-department delivery coordination previously held by the CTO. Trilingual (Spanish native, French bilingual, English professional), remote-first, with a humanities background I bring to communication and product judgment.`,

	i18n.ES: `Ingeniero full-stack senior (~4,5 años) que entrega de punta a punta — React 19 / Next.js + TypeScript en el front, back de verdad con .NET / PostgreSQL, más trabajo de plataforma (CI/CD, testing, observabilidad). Trabajo AI-native: Claude Code, agentes LLM y MCP forman parte de cómo entrego, y redacté las convenciones de ingeniería con IA de mi equipo. En un SaaS de edificios inteligentes me encargué del frontend en autonomía total, y en mi tramo final asumí la coordinación de entrega entre departamentos que antes llevaba el CTO. Trilingüe (español nativo, francés bilingüe, inglés profesional), remote-first, con una formación en humanidades que aplico a la comunicación y al criterio de producto.`,

	i18n.FR: `Ingénieur full-stack senior (~4,5 ans) qui livre de bout en bout — React 19 / Next.js + TypeScript côté front, un vrai backend .NET / PostgreSQL, ainsi que du travail de plateforme (CI/CD, tests, observabilité). Je travaille AI-native : Claude Code, agents LLM et MCP font partie de ma façon de livrer, et j'ai rédigé les conventions d'ingénierie IA de mon équipe. Dans un SaaS de bâtiments intelligents, j'ai mené le développement frontend en toute autonomie, et dans ma dernière période j'ai repris la coordination des livraisons entre départements auparavant assurée par le CTO. Trilingue (espagnol natif, français bilingue, anglais professionnel), remote-first, avec une formation en sciences humaines que j'applique à la communication et au jugement produit.`,
}
