...
var AboutMe = map[i18n.Locale]string{
	...
	i18n.ES: `Ingeniero full-stack senior (~5 años) que entrego de punta a punta — React 19 / Next.js + TypeScript en el front, .NET / PostgreSQL real en el back, más trabajo de plataforma (CI/CD, testing, observabilidad). Trabajo AI-native: Claude Code, agentes LLM y MCP forman parte de cómo entrego, y redacté las convenciones de ingeniería con IA de mi equipo. En Debos, un SaaS de edificios inteligentes, lideré la entrega del frontend y la sostuve en solitario durante ~8 meses, y en mi tramo final asumí la coordinación de entrega entre departamentos que antes llevaba el CTO. Trilingüe (español nativo, francés bilingüe, inglés profesional), remote-first, con una formación en humanidades que aplico a la comunicación y al criterio de producto.`,

	i18n.FR: `Ingénieur full-stack senior (~5 ans) qui livre de bout en bout — React 19 / Next.js + TypeScript côté front, un vrai backend .NET / PostgreSQL, ainsi que du travail de plateforme (CI/CD, tests, observabilité). Je travaille AI-native : Claude Code, agents LLM et MCP font partie de ma façon de livrer, et j'ai rédigé les conventions d'ingénierie IA de mon équipe. Chez Debos, un SaaS de bâtiments intelligents, j'ai piloté la livraison du frontend et l'ai maintenue seul pendant ~8 mois, et dans ma dernière période j'ai repris la coordination des livraisons entre départements auparavant assurée par le CTO. Trilingue (espagnol natif, français bilingue, anglais professionnel), remote-first, avec une formation en sciences humaines que j'applique à la communication et au jugement produit.`,
}
