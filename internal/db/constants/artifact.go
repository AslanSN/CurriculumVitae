...
type Artifact struct {
	...
	LogoSrc      templ.SafeURL // optional brand mark shown in the card header
	LogoAlt      string
...
var memorizameArtN = artifactNeutral{
	Name:     "Memorízame",
	ID:       "memorizame",
	LogoSrc:  helpers.RepoURL + "/images/memorizame-color.svg",
	LogoAlt:  "Memorízame logo — a two-tone M in teal and fuchsia",
